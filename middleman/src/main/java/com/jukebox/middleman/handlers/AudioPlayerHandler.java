...
import com.jukebox.middleman.UserSession;
...
public class AudioPlayerHandler extends TextWebSocketHandler {

    @Autowired
    private KurentoClient kurento;

    private final Logger log = LoggerFactory.getLogger(AudioPlayerHandler.class);
